# -*- coding: utf-8 -*-
"""
Created on Fri Jun 18 20:32:36 2021

@author: muham
"""

#Nama: Muhammad Yusuf Aldiansyah
#NIM: 20083000002
#Kelas: 2A
...
while jwb == 'y' or jwb == 'Y' :
    ...
    while b == 't' or b == 'T' :
        ...
        print('-------------------------------------------------------')
        pil = int(input("Masukan kode pilihan barang = "))
        jmlh = int(input("Masukkan Jumlah Pembelian = "))
        print('-------------------------------------------------------')
        b = input('Benar ingin Lakukan Transaksi ini? (y/t) : ')
        if b == 'y' or b == 'Y' :
            break
    idx = 0
    ...
    if totHrgsblmppn >= 200000 :
        ...
        print('Total Harga Setelah PPN    = ',format(totHrg,',.2f'))
    print('-------------------------------------------------------')
    jwb = input('Beli barang kembali? (y/t) : ')
    if jwb == 't' or jwb == 'T':
        break
print("______________________________")
print("Terima kasih telah berkungjung")
