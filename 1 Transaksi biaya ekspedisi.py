...
while jwb == 'y' or jwb == 'Y' :
    ...
    while b == 't' or b == 'T' :
        clear()
        print('-------------------------------------------------------')
        print('TRANSAKSI BIAYA EKSPEDISI LORENA')
        print('-------------------------------------------------------')
        print('PILIHAN KOTA')
        print('-------------------------------------------------------')
        ...
        print('-------------------------------------------------------')
        pil = int(input('Masukan Pilihan Kota tujuan = '))
        print('-------------------------------------------------------')
        b = input('Ingin melanjutkan kirim barang ke kota tersebut? (y/t) : ')
        if b == 'y' or b == 'Y' :
            break
    idx = 0
    ...
    print('-------------------------------------------------------')
    jwb = input('Antar kekota Lain kembali? (y/t) : ')
    if jwb == 't' or jwb == 'T':
        break
